		...
		<UiTable v-else>
			<UiTableHeader>
				<UiTableRow>
					...
					<UiTableHead class="w-[250px]">Наименование</UiTableHead>
					<UiTableHead class="w-[200px]">Email</UiTableHead>
					<UiTableHead>Откуда пришел клиент</UiTableHead>
				</UiTableRow>
			</UiTableHeader>
			<UiTableBody>
				<UiTableRow v-for="(customer, index) in (customers?.documents as unknown as ICustomer[])" :key="customer.$id">
					<UiTableCell>
